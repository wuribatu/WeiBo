...
class StatusTableViewTopView: UIView {
    ...
    /// 昵称
    private lazy var nameLabel: UILabel = UILabel.createLabel(UIColor.darkGray(), fontSize: 14)
    /// 会员图标
    private lazy var vipView: UIImageView = UIImageView(image: UIImage(named: "common_icon_membership"))
    /// 时间
    private lazy var timeLabel: UILabel = UILabel.createLabel(UIColor.darkGray(), fontSize: 14)
    /// 来源
    private lazy var sourceLabel: UILabel = UILabel.createLabel(UIColor.darkGray(), fontSize: 14)
